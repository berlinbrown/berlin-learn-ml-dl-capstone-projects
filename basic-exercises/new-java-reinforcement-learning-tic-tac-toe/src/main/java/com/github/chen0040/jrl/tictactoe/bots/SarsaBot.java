...
public class SarsaBot extends Bot {
    ...
    public void act() {
        ...
        if (!possibleActions.isEmpty()) {
            ...
            System.out.println("SarsaBot selecting grid position: " + pos + " (action=" + action + ")");
            System.out.println("Event: SarsaBot selected position " + pos.toString() + " with color=" + color);
    ...
    public void updateStrategy() {
        ...
        for (int i = moves.size() - 1; i >= 0; --i) {
            ...
            agent.update(current_move.oldState, current_move.action, current_move.newState, next_move.action,
                    current_move.reward);
        }
